export const solutions = [
    ...
    },
    {
        ...
        solutions: [
            ...
            <br> At this stage, we recognize both the specific numbers and structure of the Fibonacci sequence.  Indeed, if we consider the seqeunce we have been constructing, to find the 6th term (13), we simply summed the value of the previous two (5 + 8).  This pattern will continue
            `
        ]
    }
