export const solutions = [
    ...
    },
    {
        ...
        solutions: [
            ...
            <br> You may suspect that if there are $n$ stairs in the flight, there will be $n$ different ways to climb it.  We will see that this is not the case for $n = 4$.  Again, Nico has the choice of beginning his sequence of steps with a 1 or a 2.  If he begins with a 1, then there are 3 stairs remaining, so there are three ways he can complete his climb: (1, 1, 1, 1), (1, 1, 2), (1, 2, 1).  On the other hand, if he begins with a 2, then 2 stairs remain and hence there are two ways he can finish his climb: (2, 1, 1) and (2, 2).  So when there are four stairs, we have 5 distinct ways to climb the flight. <br>
            <br>
            `
        ]
    }
